...
public class OrderServiceTest {
    ...
    private TestRepos createRepos(String suffix) {
        ...
        return new TestRepos(eventRepository, itemRepository, orderRepository, detailRepository, orderService);
    }
    ...
    private static class TestRepos {
        ...
        private TestRepos(FlashSaleEventRepository eventRepository,
